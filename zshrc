...
alias htb='sudo openvpn b4bygroot.ovpn'
alias targetRecon='python /home/b4bygroot/Tools/TargetRecon/targetRecon.py'
...
export _JAVA_AWT_WM_NONREPARENTING=1
export PATH=$PATH:/home/b4bygroot/.gem/ruby/2.7.0/bin
